...
struct IntEvent: PlatformEvent {
  ...
  static func == (lhs: IntEvent, rhs: IntEvent) -> Bool {
    ...
    return EventChannelMessagesPigeonInternal.deepEquals(lhs.data, rhs.data)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("IntEvent")
    EventChannelMessagesPigeonInternal.deepHash(value: data, hasher: &hasher)
  }
...
class EventChannelMessagesPigeonCodec: FlutterStandardMessageCodec, @unchecked Sendable {
  override convenience init() {
    self.init(readerWriter: EventChannelMessagesPigeonCodecReaderWriter())
  }
